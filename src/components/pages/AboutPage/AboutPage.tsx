...
export const AboutPage: React.FC = () => {
  ...
  return (
    <main className='container mx-auto flex flex-grow  flex-col pl-4 pr-4 md:max-w-[900px]'>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{
          opacity: '100%',
      ...
      >
        <div className='mb-16 flex flex-col items-center'>
          ...
          <p className='mb-4'>
            Позвольте представиться. Меня зовут Борис Шевнин, мне 25 лет, и я являюсь веб-разработчиком. Моя профессиональная деятельность связана с созданием
          ...
          <p className=''>
            ...
            веб-ресурсов. В будущем, моей целью является разработка собственного веб-сайта с
            товарами из Китая. Также, в моих планах - запуск интернет-магазина по парфюмерии.
          </p>
        </div>

        <div className='flex flex-col items-center'>
          <h2 className='mb-8 text-center font-dancingScript text-[2.4rem]'>
          ...
          <ul className='list-disc xs:ml-4'>
            ...
            <li className='mb-3'>
              <b className='mr-2'>
                Оптимистическое обновление приы добавлении/удалении рецепта в базу-избранных
                Firebase:
              </b>
              Реализовано оптимистическое обновление, которое позволяет вам моментально
              добавить/удалить рецепт в избранное, а затем асинхронно синхронизировать его с
              Firebase.
            </li>
            <li className='mb-3'>
            ...
            <li className='mb-3'>
              <b className='mr-2'>Компонент React.lazy и Заглушка:</b>Для улучшения
              производительности используется React.lazy для ленивой загрузки компонента приложения,
              что позволяет ускорить начальную загрузку страницы. Также добавлено отображение
              загрузчика при загрузке сайта.
            </li>
            <li className='mb-3'>
              <b className='mr-2'>Использование Tailwind:</b>В этом проекте я познакомился с
              Tailwind CSS и внедрили его для создания дизайна. Дизайн разрабатывался самостоятельно
              по ходу движения разработчки сайта. Упор на дизайн не ставился.
            </li>
            <li className='mb-3'>
            ...
            <li className='mb-3'>
              ...
              пользовательского опыта на сайте есть карусель и слайдер написанные с помощью
              библиотеки <b>Swiper</b>.
            </li>
            <li className='mb-3'>
